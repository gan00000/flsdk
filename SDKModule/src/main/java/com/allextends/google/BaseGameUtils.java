...
//    <string name="mstr_dogmatkin_knowledgesive">There was an issue with sign-in, please try again later.</string>
//    <string name="mstr_coldior_come">Failed to sign in. Please check your network connection and try again.</string>
//    <string name="mstr_omenain_betweenast">The application is incorrectly configured. Check that the package name and signing certificate match the client ID created in Developer Console. Also, if the application is not yet published, check that the account you are trying to sign in with is listed as a tester account. See logs for more information.</string>
//    <string name="mstr_enough_alsoator">License check failed.</string>
//    <string name="mstr_minutelike_pitilet">Unknown error.</string>
