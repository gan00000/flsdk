...
import com.ldy.sdk.login.widget.v2.AccountChangePwdLayoutV2;
import com.ldy.sdk.login.widget.v2.AccountFindPwdLayoutV2;
import com.ldy.sdk.login.widget.v2.AutoLoginLayoutV2;
import com.ldy.sdk.login.widget.v2.LoginWithRegLayout;
import com.ldy.sdk.login.widget.v2.MainHomeLayout;
import com.ldy.sdk.login.widget.v2.TermsViewV3;
import com.ldy.sdk.login.widget.v2.ThirdPlatBindAccountLayoutV2;
import com.ldy.sdk.login.widget.v2.WelcomeBackLayout;
...
//        initAutoLoginView();
    ...
    @Override
    public void loginSuccess(SLoginResult sLoginResponse) {
    ...
    @Override
    public void changePwdSuccess(SLoginResult sLoginResponse) {
    ...
    @Override
    public void findPwdSuccess(SLoginResult sLoginResponse) {
//        if (findPwdView != null){
...
//        toAccountLoginView();
    ...
    @Override
    public void accountBindSuccess(SLoginResult sLoginResponse) {
//        if (bindFbView != null){
