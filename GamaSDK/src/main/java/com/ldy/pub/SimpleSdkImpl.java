...
import com.mybase.utils.PermissionUtil;
import com.mybase.utils.SStringUtil;
import com.mybase.utils.SignatureUtil;
...
import com.ldy.sdk.pay.IPayFactory;
...
import com.ldy.base.bean.SGameLanguage;
import com.ldy.base.bean.SPayType;
import com.ldy.base.cfg.ConfigRequest;
...
import com.allextends.huawei.HuaweiPayImpl;
    ...
    public void openCs(Activity activity) {
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ConfigModel configModel = SdkUtil.getSdkCfg(activity.getApplicationContext());
                if (configModel != null && configModel.getUrl() != null && SStringUtil.isNotEmpty(configModel.getUrl().getCsUrl())) {
...
//                        int reviewErrorCode = task.getException().getErrorCode();
    ...
    @Override
    public void showBindPhoneView(Activity activity, SFCallBack<BaseResultModel> sfCallBack) {
    ...
    @Override
    public void requestVfCode(Activity activity, String areaCode, String telephone, SFCallBack<BaseResultModel> sfCallBack) {
    ...
    @Override
    public void requestBindPhone(Activity activity, String areaCode, String telephone,String vfCode, SFCallBack<SLoginResult> sfCallBack) {
