...
import com.gama.data.login.request.QueryFbToGamaUserIdBean;
import com.gama.data.login.request.GamaUserRelateFbBean;
import com.gama.data.login.response.FbUser;
import com.gama.data.login.response.QueryFbUserResult;
import com.gama.data.login.response.SLoginResult;
import com.gama.sdk.utils.DialogUtil;
import com.gama.allextends.facebook.FbSp;
import com.gama.allextends.facebook.FriendProfile;
import com.gama.allextends.facebook.SFacebookProxy;
...
public class QueryFbToGamaUserIdTask {
        ...
        if (sFacebookProxy != null){
            sFacebookProxy.requestMyFriends(activity, new SFacebookProxy.RequestFriendsCallBack() {
                ...
                public void onSuccess(JSONObject graphObject, final List<FriendProfile> friendProfiles) {
                    ...
                    absHttpRequest.setReqCallBack(new ISReqCallBack<SLoginResult>() {
                        @Override
                    ...
                    absHttpRequest.excute(SLoginResult.class);
                }
    ...
    private void queryFbUser(List<FriendProfile> friendProfiles) {
        ...
        absHttpRequest.setLoadDialog(DialogUtil.createLoadingDialog(activity, "Loading..."));
        absHttpRequest.setReqCallBack(new ISReqCallBack<QueryFbUserResult>() {

            @Override
            public void success(QueryFbUserResult queryFbUserResponse, String rawResult) {
        ...
        absHttpRequest.excute(QueryFbUserResult.class);
    }
