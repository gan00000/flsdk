package com.ldy.sdk.pay.gp.constants;
...
public class GooglePayContant {
	 ...
	 */
	public static final String PAY_FROM = "mw";
	/**
	 * WIFI wifi参数值
	 */
...
//	public static final String PURCHASE_OBJECT = "PURCHASE"; //改用 GamaCommonKey.PURCHASE_DATA
}
