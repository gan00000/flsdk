...
public interface IGama extends IGameLifeCycle {
    ...
    void registerRoleInfo(Activity activity,String roleId,String roleName,String roleLevel,String severCode,String serverName);

    void login(Activity activity,ILoginCallBack iLoginCallBack);

    void pay(Activity activity, SPayType payType, String cpOrderId, String productId, String roleLevel, String extra);
    ...
    void openWebview(Activity activity, String roleLevel, String roleVipLevel);
    ...
    void openPlatform(Activity activity, String roleLevel, String roleVipLevel);
}
