...
public class LoginAnnouceLayoutV2 extends SLoginBaseRelativeLayout implements View.OnClickListener {
    ...
    public LoginAnnouceLayoutV2(Context context, AttributeSet attrs, SLoginResponse sLoginResponse) {
        super(context, attrs);
        this.sLoginResponse = sLoginResponse;
    }

    public LoginAnnouceLayoutV2(Context context, AttributeSet attrs, int defStyleAttr, SLoginResponse sLoginResponse) {
