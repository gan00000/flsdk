...
public class AccountChangePwdLayoutV2En extends SLoginBaseRelativeLayoutEn implements View.OnClickListener {
    ...
    public AccountChangePwdLayoutV2En(Context context) {
        super(context);
    }

    public AccountChangePwdLayoutV2En(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public AccountChangePwdLayoutV2En(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private View onCreateView(LayoutInflater inflater) {
        contentView = inflater.inflate(R.layout.v2_account_change_pwd_en, null);
    ...
    private void changePwd() {
        ...
        if (SStringUtil.isEqual(password,newPassword)){
            ToastUtils.toast(getActivity(), R.string.en_py_old_equel_new_pwd);
            return;
        }
