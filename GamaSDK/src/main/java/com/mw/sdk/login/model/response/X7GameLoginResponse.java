...
public class X7GameLoginResponse extends BaseResponseModel {
...
//        private String freeRegisterPwd = "";
        ...
        public X7LoginData getX7data() {
            return x7data;
        }

        public void setX7data(X7LoginData x7data) {
            this.x7data = x7data;
        }
