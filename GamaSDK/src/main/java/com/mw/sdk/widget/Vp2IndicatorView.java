...
public class Vp2IndicatorView extends View {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    private void init() {
        mColorSelected = getContext().getColorStateList(R.color.c_indicatorView_selected);
        mColorUnSelected = getContext().getColorStateList(R.color.c_indicatorView_unselected);
        mIndicatorItemDistance = dip2px(10);
        mIndicatorStyle = STYLE_CIRCLR_CIRCLE;
        circleCircleRadius = dip2px(5);
    }
    ...
    public void pageSelected(ViewPager2 vp2, int position){
