...
public class Security {
    ...
    private static final String SIGNATURE_ALGORITHM_HUAWEI = "SHA256withRSA";
    ...
    public static boolean verifyPurchase(String base64PublicKey, String signedData,
                                         String signature, String storeType) throws IOException {
        ...
        return verify(key, signedData, signature, storeType);
    }
     ...
     */
    public static boolean verify(PublicKey publicKey, String signedData, String signature, String storeType) {
        byte[] signatureBytes;
        try {
        ...
        try {
            Signature signatureAlgorithm = Signature.getInstance(
                    storeType.equals(Constants.HUAWEI) ? SIGNATURE_ALGORITHM_HUAWEI :
